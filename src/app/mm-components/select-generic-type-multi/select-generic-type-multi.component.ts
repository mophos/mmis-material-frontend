...
export class SelectGenericTypeMultiComponent implements OnInit {
  ...
  constructor(private basicService: StandardService, private alertService: AlertService) {
  ...
  getDefaultGenericType() {
    let obj = {};
    if (sessionStorage.getItem('genericTypeLV')) {
      if (sessionStorage.getItem('genericTypeLV1')) {
        const lv1 = sessionStorage.getItem('genericTypeLV1');
        this.genericTypeLV1Id = lv1.length !== 1 ? null : lv1;
      }
      if (sessionStorage.getItem('genericTypeLV2')) {
        const lv2 = sessionStorage.getItem('genericTypeLV2');
        this.genericTypeLV2Id = lv2.length !== 2 ? null : lv2;
      }
      if (sessionStorage.getItem('genericTypeLV3')) {
        const lv3 = sessionStorage.getItem('genericTypeLV3');
        this.genericTypeLV3Id = lv3.length !== 3 ? null : lv3;
      }
  ...
  generateObj() {
    ...
    sessionStorage.setItem('genericTypeLV', 'Y');
    sessionStorage.setItem('genericTypeLV1', obj.generic_type_lv1_id);
    sessionStorage.setItem('genericTypeLV2', obj.generic_type_lv2_id);
    sessionStorage.setItem('genericTypeLV3', obj.generic_type_lv3_id);
